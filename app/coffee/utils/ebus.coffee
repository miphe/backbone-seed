...
# The event-bus top level can be used as a channel of
# communication, since it's a Marionette object
# (meaning it extends Backbone's event object), however
# it's recommended to use channels on the second level.
